...
<body>
    ...
    <div id="main">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center"><h3>Lịch hẹn của khách hàng</h3></div>
                <div class="col-12">
                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="get">
                        <table>
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM booking where Status=N'Chưa hoàn thành'";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    ?>
                                        ...
                                        <td> <a href="booking_admin.php?username=<?php echo $row["username"];?>">Done</a>
                                        </tr><?php
                                    }
                                } else {
                                    echo "<tr>";
                ...
                <div class="col-12 text-center"><h3>Lịch hẹn đã hoàn thành</h3></div>
                <div class="col-12">
                    <form action="" method="">
                        <table>
                            <thead>
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM booking where Status=N'Đã hoàn thành'";
                                $result = mysqli_query($conn, $sql);
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td>" . $row["date_founded"] . "</td>";
                                        echo "<td>" . $row["time_book"] . "</td>";
